...
try {
    ...
    // El resto del código PHP original
} catch (Exception $e) {
    // Registrar el error
    error_log("Error en index.php: " . $e->getMessage(), 3, __DIR__ . "/logs/error.log");

    // Redirigir a la página de diagnóstico con mensaje de error
    header("Location: diagnostico.php?error=500");
    exit();
}
?>
      ...
      <nav class="menu">
        ...
        <div class="user">
          ...
          <div class="user-dropdown" id="user-dropdown">
              <div class="user-info">
                  <span class="username"><?php echo htmlspecialchars($_SESSION['username'] ?? 'Usuario'); ?></span>
                  <span class="email"><?php echo htmlspecialchars($_SESSION['email'] ?? 'correo@ejemplo.com'); ?></span>
              </div>
              <a href="php/manual.php" class="manual-btn">Manual de Usuario</a>
      ...
      <div class="container-all3">
        ...
        <div class="contact-container">
          ...
          <form class="contact-form" action="#" method="post">
            ...
            <input class="contact-input" type="text" name="apellido" placeholder="Apellido"/>
